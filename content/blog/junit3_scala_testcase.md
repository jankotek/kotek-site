+++
title = "JUnit3 Scala TestCase"
template = "page.html"
description = "There is number of new testing framework for Java and Scala. For example JUnit4, TestNG, Spec, ScalaTest... I never liked annotation driven test cases or 'story driven tests'. So I wrote my own TestCase which works with JUnit3 and can use some Scala features."
path = "blog/junit3_scala_testcase"
date = 2010-11-28
[extra]
render_title = false
+++
